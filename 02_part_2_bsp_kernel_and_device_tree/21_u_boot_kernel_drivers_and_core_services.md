...
### 21.1.2 每個階段都可視為獨立 Firmware Image
...
### 21.1.4 U-Boot 與 Linux Kernel 的責任邊界
...
### 21.2.2 TPL: Tertiary Program Loader
...
### 21.2.3 VPL: Verifying Program Loader
...
### 21.2.4 SPL: Secondary Program Loader
...
### 21.2.7 ARM Trusted Firmware, OpenSBI 與其他 Firmware
...
### 21.2.9 SRAM, DDR, Stack, BSS 與 Relocation
...
### 21.2.11 Image Packaging: Raw, FIT 與 Binman
...
## 21.5 U-Boot Environment 與 Boot Policy
...
## 21.7 Standard Boot, A/B 與 Recovery
...
### 21.12.1 Platform Driver 的 Probe 如何被呼叫
...
### 21.12.2 I2C Driver 的 Probe 如何被呼叫
...
### 21.12.3 Built-in 與 Module 對 Probe 時機的影響
...
### 21.13.1 Resource 是什麼 [待確認: 原文編號為 9.5.1]
...
### 21.13.5 為什麼常看到 `IS_ERR()` 與 `PTR_ERR()`
...
### 21.13.7 Probe 成功後還要註冊 Subsystem Interface
...
### 21.14.2 Built-in Driver 也需要 Register
...
### 21.15.5 取得 Clock, Reset, Regulator 與 IRQ
...
## 21.16 Deferred Probe: 為什麼 Driver 會說"晚點再試"
...
### 21.16.2 短暫 Deferred 與長期 Deferred
...
### 21.16.3 Driver 中如何保留 Deferred Probe
...
## 21.17 Kernel Config, Built-in 與 Module
...
## 21.18 Driver 如何把資料交給 Userspace
...
## 21.19 OpenBMC 如何使用 Kernel Interface
...
### 21.19.2 為什麼 Sysfs 有值, D-Bus 還是可能沒有
...
## 21.20 如何判斷該改 DTS, Driver 或 OpenBMC 設定
...
## 21.22 Dynamic Debug 與 Ftrace 是什麼

一般 `dmesg` 只顯示 driver 主動輸出的訊息. 若資訊不夠, 可使用 kernel 提供的除錯機制.

### 21.22.1 Dynamic Debug
...
### 21.24.5 確認 Probe 與 Dependencies
...
### 21.24.6 確認 Subsystem Interface
...
### 21.24.7 確認 OpenBMC Service 與 D-Bus
...
## 21.26 Kernel Driver Debug Log 收集
