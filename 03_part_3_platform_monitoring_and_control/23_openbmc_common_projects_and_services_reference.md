...
## 23.3 D-Bus 與 ObjectMapper 相關 project
...
## 23.5 Sensor / Inventory / Entity Manager 相關 project
...
## 23.6 Power / Fan / Thermal 相關 project
...
## 23.8 Redfish / Web / IPMI 相關 project(含 IPMI 擴充元件)
...
## 23.9 Logging / Event / State 相關 project
...
## 23.10 Host 日誌, POST Code 與 Debug Dump
...
## 23.12 MCTP / PLDM / Host Interface 相關 project
...
## 23.13 常用 recipe / service / runtime 路徑對照
